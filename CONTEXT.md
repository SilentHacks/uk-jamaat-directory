...
- **Done (Phase 12):** Dependabot, PR dependency review, code license and intended ODbL public-data license docs, security reporting policy, `docs/github/` workflow notes.
