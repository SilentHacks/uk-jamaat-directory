...
class Extractor(BaseMosqueWebsiteExtractor):
    key = "south_essex_islamic_community_centre_4b3178aa"
    version = "2026.06.12.1"
    source_match = SourceMatch(domains=("seit.org.uk",))
    refresh_policy = RefreshPolicy(frequency=RunFrequency.DAILY)
    targets = (
        TargetSpec(
            label="timetable",
            url="https://masjidbox.com/prayer-times/south-essex-islamic-trust",
