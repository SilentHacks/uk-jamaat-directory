...
class Extractor(BaseMosqueWebsiteExtractor):
    key = "al_bhokari_education_centre_107f9b66"
    version = "2026.06.12.1"
    source_match = SourceMatch(domains=("albokhari.org",))
    refresh_policy = RefreshPolicy(frequency=RunFrequency.DAILY)
    targets = (
        TargetSpec(
            label="timetable",
            url="https://albokhari.org/education-centre-uk/",
    ...
    def extract(self, ctx: ExtractContext) -> ExtractorResult:
        ...
        # Daily dptTimetable widget: Prayer | Begins | Iqamah (today only, no date col)
        ...
        # Jumu'ah cell (may contain 1 or more times)
