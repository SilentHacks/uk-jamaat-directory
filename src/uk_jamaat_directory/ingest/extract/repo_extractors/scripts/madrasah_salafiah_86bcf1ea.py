...
class Extractor(TableTimetableExtractor):
    key = "madrasah_salafiah_86bcf1ea"
    ...
    def extract(self, ctx):
        ...
        # Site quirk (same as sibling jamiat_ahl_e_hadith extractor): parsed header row has 12 cells (due to colspan in "Nov" label) while data rows have 13.
