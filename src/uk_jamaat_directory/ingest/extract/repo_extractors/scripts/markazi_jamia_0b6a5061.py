...
from uk_jamaat_directory.ingest.extract.helpers import dates, html as html_helpers, times
...
class Extractor(BaseMosqueWebsiteExtractor):
    ...
    def extract(self, ctx: ExtractContext) -> ExtractorResult:
        ...
        for prayer_class, prayer in prayer_map.items():
            ...
            jamaat_match = re.search(r'<div\s+class="prayer-jamaat"[^>]*>', prayer_section, re.DOTALL)
