...
class Extractor(BaseMosqueWebsiteExtractor):
    key = "bromley_islamic_centre_c8be02aa"
    version = "2026.06.12.1"
    source_match = SourceMatch(domains=("bromleyislamiccentre.org.uk",))
    refresh_policy = RefreshPolicy(frequency=RunFrequency.DAILY)
    targets = (
        TargetSpec(
            label="timetable",
            url="https://masjidbox.com/prayer-times/bromley-islamic-centre",
    ...
    def _parse_timetable(self, text: str) -> list[dict]:
        ...
        # inside a JS string in the initial HTML.
        ...
        if m:
            ...
            if days:
                return days
        # Fallbacks for other possible embeddings
