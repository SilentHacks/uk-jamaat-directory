...
class Extractor(BaseMosqueWebsiteExtractor):
    key = "bourneville_masjid___community_centre_c3e87838"
    version = "2026.06.12.1"
    source_match = SourceMatch(domains=("sbmca.org.uk", "mawaqit.net"))
    refresh_policy = RefreshPolicy(frequency=RunFrequency.DAILY)
    targets = (
        TargetSpec(
            label="timetable",
            url="https://mawaqit.net/en/w/sbmca-birmingham-b30-1qd-united-kingdom?showOnly5PrayerTimes=0",
