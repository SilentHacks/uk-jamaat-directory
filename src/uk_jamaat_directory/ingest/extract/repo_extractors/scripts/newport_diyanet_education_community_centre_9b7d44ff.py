...
class Extractor(BaseMosqueWebsiteExtractor):
    key = "newport_diyanet_education_community_centre_9b7d44ff"
    version = "2026.06.12.1"
    source_match = SourceMatch(domains=("newportdiyanet.org", "mawaqit.net"))
    refresh_policy = RefreshPolicy(frequency=RunFrequency.DAILY)
    targets = (
        TargetSpec(
            label="timetable",
            url="https://mawaqit.net/en/w/newport-diyanet-newport-np20-2je-united-kingdom?showOnly5PrayerTimes=0",
