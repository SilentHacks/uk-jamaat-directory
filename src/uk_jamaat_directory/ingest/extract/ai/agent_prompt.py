...
def build_agent_prompt(
    ...
    return (
        ...
        "- You may use websearch ONCE as a fallback "
        "if site navigation completely fails.\n"
        "- Do NOT visit web.archive.org, archive.org, "
        "webcache.googleusercontent.com, or any other archive or caching service. "
        "If a URL redirects to an archive, do NOT follow it. "
